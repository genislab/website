...
function elite_blog_render_categories_section( $section_content ) {
	...
	$categories_title = get_theme_mod( 'elite_blog_categories_title', __( 'Discover Asia', 'marvel-blog' ) );
	?>

	<section id="elite_blog_categories_section" class="categories-section section-splitter no-background categories-style-2">
		<?php
					...
					<div class="categories-container">
						<div class="categories-inner">
							...
							<div class="categories-details">
								...
								<?php
								if ( $content['count'] <= 1 ) {
									$post_count = $content['count'] . __( ' post', 'marvel-blog' );
								} else {
									$post_count = $content['count'] . __( ' posts', 'marvel-blog' );
								}
								?>
