...
define('PIGEON_THEME_URL','https://wwwows.com/product/pigeon-wordpress-theme/');
define('PIGEON_SOCIAL_URL','https://www.facebook.com/wwwows/');
define('PIGEON_DOCS_URL','https://wwwows.com/docs');

// Upgrade content
if ( ! function_exists( 'pigeon_admin_theme_page_more_features' ) ) {
	function pigeon_admin_theme_page_more_features() { ?>
<div class="wwwows-tp-s-box wwwows-tp-premium">
    <h4><?php esc_html_e( 'Pigeon Premium', 'pigeon' ); ?></h4>
    <p><?php esc_html_e( 'If You need the premium features for Your site, check the theme page on wwwows.com', 'pigeon' ); ?></p>
    <a href="<?php echo esc_url(PIGEON_THEME_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Get Pigeon Premium', 'pigeon' ); ?></a>
</div>
<?php
	}
}
...
// Title content
if ( ! function_exists( 'pigeon_admin_theme_page_title' ) ) {
	function pigeon_admin_theme_page_title() { ?>
<div class="wwwows-tp-title-area">
    <div class="wwwows-tp-title-content">
        <h1><?php esc_html_e( 'Pigeon WordPress Theme', 'pigeon' );?></h1>
        <p><?php esc_html_e( 'Thank You for using Pigeon! Check all the theme features.', 'pigeon' );?></p>
    </div>
    <h2><?php esc_html_e( 'Here You can see the theme features. At the theme page on wwwows.com You can find more details.', 'pigeon' );?></h2>
</div>
<?php
	}
}    
 
// Pigeon admin page content   
if ( ! function_exists( 'pigeon_admin_theme_page' ) ) {
	function pigeon_admin_theme_page() { ?>
<div id="wwwows-tp-page-body">
<div id="wwwows-tp-page-left">
	<?php pigeon_admin_theme_page_title(); ?>
    <div class="wwwows-theme-features">
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Free', 'pigeon' ); ?></span><?php esc_html_e( ' Pigeon features', 'pigeon' ); ?></h3>
        
        <div class="clearflex"></div>
        
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PIGEON_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Full Site Editor', 'pigeon' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PIGEON_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Fast Pageload', 'pigeon' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PIGEON_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'GPL License', 'pigeon' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PIGEON_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Partial Block Templates', 'pigeon' ); ?></h4>
        </div>
        <div class="wpp-c20">
        	<a href="<?php echo esc_url(PIGEON_THEME_URL); ?>" target="_blank">
            ...
            <h4><?php esc_html_e( 'Translation Ready', 'pigeon' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Premium', 'pigeon' ); ?></span><?php esc_html_e( ' Pigeon features', 'pigeon' ); ?></h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Additional Full Block Templates', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'WooCommerce Ready', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Google Fonts Options', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Wwwows Blocks', 'pigeon' ); ?></h4>
        </div>
        
        <div class="clearflex"></div> 
        
        <h3 class="wpp-heading"><span><?php esc_html_e( 'Additional blocks', 'pigeon' ); ?></span><?php esc_html_e( ' for Pigeon premium', 'pigeon' ); ?></h3>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll animations', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Responsive control', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Back to top', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Image cursor', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Stylish scrollbar', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Accordion', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Countdown', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Icon', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Progress', 'pigeon' ); ?></h4>
        </div>
        ...
        <div class="wpp-c20">
            ...
            <h4><?php esc_html_e( 'Scroll text', 'pigeon' ); ?></h4>
        </div>
...
<div id="wwwows-tp-page-right">
	<?php pigeon_admin_theme_page_more_features(); ?>
	<div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows Documentation', 'pigeon' ); ?></h4>
        <p><?php esc_html_e( 'If You`ve stuck, the documentation may help on Wwwows.com', 'pigeon' ); ?></p>
        <a href="<?php echo esc_url(PIGEON_DOCS_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Wwwows Documentation', 'pigeon' ); ?></a>
    </div>
    <div class="wwwows-tp-s-box wwwows-tp-doc">
    	<h4><?php esc_html_e( 'Wwwows on Facebook', 'pigeon' ); ?></h4>
        <p><?php esc_html_e( 'If You want to get useful infos and discounts about Wwwows, follow Wwwows on Facebook.', 'pigeon' ); ?></p>
        <a href="<?php echo esc_url(PIGEON_SOCIAL_URL); ?>" target="_blank" class="wwwows-tp-button"><?php esc_html_e( 'Go to Facebook', 'pigeon' ); ?></a>
    </div>
</div>
<?php
	}
